...
int main(void)
{
  ...
  // Configuration des GPIO, I2C, SPI, TIM, USART, etc.
  // Mise en place du capteur de distance et des moteurs
  /* USER CODE END 1 */
  ...
  MX_USART1_UART_Init();
  /* USER CODE BEGIN 2 */
  // Initialisation du capteur de distance TOF (VL53L0X)
  initToF(); //
  /* USER CODE END 2 */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
    // Lecture de la distance mesurée par le capteur TOF
    readToF(); //
    HAL_Delay(1000);
  }
  /* USER CODE END 3 */
